...
const sections = [
  ...
  { id: "active-recall", title: "Active Recall Techniques", icon: "🧠" },
  { id: "spaced-repetition", title: "Spaced Repetition System", icon: "📅" },
  { id: "time-management", title: "Strategic Time Management", icon: "⏰" },
  { id: "stress-management", title: "Stress & Mental Health", icon: "🧘" },
  { id: "environment", title: "Optimal Study Environment", icon: "🏠" },
  { id: "revision", title: "Effective Revision Strategies", icon: "📝" },
  { id: "exam-day", title: "Exam Day Excellence", icon: "🎯" },
  { id: "conclusion", title: "Your Success Journey", icon: "🚀" },
];
                ...
                content: (
                  <>
                    ...
                    <Badge className="bg-red-50 text-red-700 border border-red-200">
                      💡 Use Do Not Disturb mode to avoid distraction!
                    </Badge>
                  </>
                ),
              },
